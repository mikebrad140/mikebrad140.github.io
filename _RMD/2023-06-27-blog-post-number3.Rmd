...
**This examples shows how to store pieces of the RegressionList_Example function from a single linear model into a list. For multiple models, you can then store multiple list results into a single list. Note that you could extend this example to perform additional analyses or comparisons based on the stored results in the models_list list.**
